...
program
  ...
  .option("-e | --rsaen <decryptString>", "解密 [decryptString]")
  .option("-c | --rsacr <dc>", "產生指定 dc 的 RSA public/private key 檔案")
  .parse()
...
if (opts.rsaen && opts.default) {
  ...
  // 上面可測試解密
  const decryptString = program.getOptionValue("rsaen")
